...
import { SearchComposer, defaultSearch, type SearchState } from "@/components/marevo/SearchComposer";
...
function SearchPage() {
  ...
  const results = useMemo(() => {
    ...
    if (maxPrice) list = list.filter((e) => (e.priceUnit === "total" ? e.price : e.price * composer.guests) <= maxPrice);
          ...
          <div className="mx-auto max-w-[1240px] px-5 py-7 sm:px-8">
            ...
            <div className="mt-5">
              <SearchComposer
                ...
                variant="compact"
                onSubmit={(v) =>
                  navigate({ to: "/search", search: { q: v.q, date: v.date, guests: v.guests, trip: v.trip } })
                }
              />
            </div>
          </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                <Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
                  ...
                  <SheetContent side="bottom" className="max-h-[85dvh] overflow-y-auto rounded-t-2xl p-0 [&>button]:hidden">
                    ...
                    <div className="sticky bottom-0 border-t border-border bg-background px-5 py-4">
                      <Button variant="sun" size="lg" className="w-full" onClick={() => setDrawerOpen(false)}>
            ...
            {results.length > 0 ? (
              ...
              <div className="mt-6 rounded-xl border border-dashed border-border bg-sand/60 px-6 py-16 text-center">
                ...
                <p className="mx-auto mt-3 max-w-sm leading-relaxed text-muted-foreground">
                  Our fleet is deliberately small. Widen the group size or budget, or send us the day you have in mind
                  and we'll ask the operators directly.
                </p>
